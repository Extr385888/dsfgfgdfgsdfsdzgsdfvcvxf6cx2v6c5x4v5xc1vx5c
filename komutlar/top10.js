...
exports.run = async (client, message, args) => {
  if(message.author.id !== "702463861034319974") return message.channel.send(new Discord.MessageEmbed().setColor("RANDOM").setDescription("Way Çakal Bu Sahibimin Komutu!"))
                 if(isNaN(args[0])){
