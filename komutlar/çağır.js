...
exports.run = (client, message, args) => {
  ...
  if (wenzy.length < 6) return message.channel.send("❌ Sebebiniz Daha Geçerli Olması İçin **En Az 6** Karakterli Olmalıdır!");//karakter sayı değeri değiştirilebilir. nasıl yapıcağınızı bilmiyosanız kod paylaşımıcısıyla iletişime geçin.
